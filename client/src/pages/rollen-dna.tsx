...
const roleResultTexts: Record<ResultKey, RoleResultEntry> = {
  IMP_INT_ANA: {
    ...
    body: [
      "Im Arbeitsalltag wird diese Rolle vor allem durch eine aktive und entscheidungsorientierte Arbeitsweise gepr\u00e4gt. Themen werden fr\u00fch aufgegriffen, Verantwortung wird \u00fcbernommen und Entscheidungen werden vergleichsweise z\u00fcgig getroffen. Die Rolle wirkt dadurch dynamisch und handlungsstark.",
  ...
  IMP_ANA_INT: {
    ...
    body: [
      "Im Arbeitsalltag wird diese Rolle vor allem durch Entscheidungsst\u00e4rke und Umsetzungsorientierung gepr\u00e4gt. Themen werden aktiv aufgegriffen, Verantwortung wird \u00fcbernommen und Entscheidungen werden vergleichsweise z\u00fcgig getroffen.",
  ...
  INT_ANA_IMP: {
    ...
    body: [
      "Im Arbeitsalltag pr\u00e4gt vor allem Zusammenarbeit und Abstimmung diese Rolle. Austausch, Gespr\u00e4che und ein gutes Gesp\u00fcr f\u00fcr Menschen stehen im Mittelpunkt.",
  ...
  return (
    ...
    >
      ...
      <div style={{ borderTop: "1px solid rgba(0,0,0,0.06)", marginTop: 20, paddingTop: 16, marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 14, color: "#58585D", lineHeight: 1.65, margin: 0 }}>
          {arbDetail[0]}
    ...
    {showFuehrungInfo && (
      <>
        ...
        >
          ...
          <p style={{ fontSize: 13, color: "#58585D", lineHeight: 1.6, marginBottom: 16 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {[
              ...
              <div key={item.label}>
                ...
                <span style={{ fontSize: 13, color: "#58585D", lineHeight: 1.5 }}>{item.desc}</span>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-5">
            ...
            {allCollapsed ? null : currentStep === 1 ? (
              <Card className="bg-white/60 dark:bg-card/60 backdrop-blur-sm border-card-border animate-in fade-in slide-in-from-bottom-2 duration-400" style={{ overflow: "visible", position: "relative", zIndex: 100 }} data-testid="card-step-1">
                <div style={{ padding: "32px 32px 28px", overflow: "visible" }}>
                  ...
                  <p style={{ fontSize: 13, color: "#58585D", lineHeight: 1.6, margin: "0 0 28px" }}>
                  ...
                  <div className="mb-0" style={{ zIndex: 100 }} data-testid="input-beruf-wrapper">
                    ...
                    <div style={{ marginTop: 28 }}>
                      <p style={{ fontSize: 12.5, fontWeight: 600, color: "#58585D", margin: "0 0 2px" }}>Arbeitsmarkt</p>
                ...
                >
                  ...
                  {bioCheckOpen && (<>
                    {bioCheckIntroOverride ? (
                      <p style={{ fontSize: 13, color: "#58585D", lineHeight: 1.8, marginTop: 14, whiteSpace: "pre-line" }} data-testid="text-biocheck-intro">
                        {bioCheckIntroOverride}
                      </p>
                    ) : (<>
                      <div style={{
                        ...
                        {analysisPrincipleText.body.map((line, i) => (
                          <p key={i} style={{ fontSize: 13, color: "#58585D", lineHeight: 1.7, margin: i === 0 ? 0 : "6px 0 0 0" }}>{line}</p>
                        ))}
                      </div>
                      ...
                      <div style={{ marginTop: 14 }} data-testid="card-anforderungsprofil">
                        ...
                        <p style={{ fontSize: 13, color: "#58585D", lineHeight: 1.7, margin: "0 0 14px 0" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                          {[
                            ...
                            <div key={d.label} style={{
                              ...
                              <p style={{ fontSize: 11, color: "#58585D", lineHeight: 1.5, margin: 0 }}>{d.desc}</p>
                            </div>
                          ))}
                        </div>
            ...
            {allCollapsed && (
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }} data-testid="dna-summary-grid">
                  {[
                    ...
                    >
                      ...
                      <p style={{ fontSize: 13, color: "#58585D", margin: 0, lineHeight: 1.5, paddingLeft: 21 }}>{card.value}</p>
                    </div>
                  ))}
                  <div
                    style={{
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 12, paddingLeft: 21, flexWrap: "wrap" }}>
                      <span style={{ fontSize: 12, color: "#58585D" }}><strong style={{ color: "#1D1D1F" }}>{hauptCount}</strong> Tätigkeiten</span>
                      <span style={{ fontSize: 12, color: "#58585D" }}><strong style={{ color: "#1D1D1F" }}>{nebenCount}</strong> Humankompetenzen</span>
                      {fuehrung !== "Keine" && <span style={{ fontSize: 12, color: "#58585D" }}><strong style={{ color: "#1D1D1F" }}>{fuehrungCount}</strong> Führung</span>}
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                {bioCheckOpen && (<>
                  {bioCheckIntroOverride ? (
                    <p style={{ fontSize: 13, color: "#58585D", lineHeight: 1.8, marginTop: 14, whiteSpace: "pre-line" }} data-testid="text-biocheck-intro-collapsed">
                      {bioCheckIntroOverride}
                    </p>
                  ) : (<>
                    <div style={{
