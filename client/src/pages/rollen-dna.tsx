                  ...
                  {bioCheckOpen && (<>
                    {bioCheckIntroOverride ? (
                      ...
                      <div style={{
                        ...
                        <h3 style={{ fontSize: 14, fontWeight: 700, color: "#1D1D1F", margin: "0 0 10px 0", display: "flex", alignItems: "center", gap: 6 }}><ClipboardList style={{ width: 14, height: 14, color: "#0071E3", flexShrink: 0 }} />Anforderungsprofil der Stelle</h3>
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{
                          ...
                          <h3 style={{ fontSize: 14, fontWeight: 700, color: "#1D1D1F", margin: "0 0 10px 0", display: "flex", alignItems: "center", gap: 6 }}><Lightbulb style={{ width: 14, height: 14, color: "#0071E3", flexShrink: 0 }} />Ergebnis der Analyse</h3>
