                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{
                          ...
                          <p lang="de" style={{ fontSize: 14, color: "#48484A", lineHeight: 1.7, margin: 0, ...reportTextStyle }} data-testid="text-biocheck-body">
                            ...
                            >
                              ...
                              <div style={{
                                ...
                                <div style={{
                                  ...
                                  alignItems: "center",
                                  paddingLeft: 8,
                                  minWidth: bar.value === 0 ? 0 : (bar.value < 11 ? 8 : 44),
                                }}>
                                  {bar.value >= 11 && <span style={{
                                    fontSize: 12,
                                    fontWeight: 700,
                                    color: "#FFFFFF",
                                    whiteSpace: "nowrap",
                                ...
                                <div key={bar.label} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                                  ...
                                  <div style={{ flex: 1, position: "relative", height: 26 }}>
                                    ...
                                    <div style={{
                                      ...
                                      minWidth: bar.value === 0 ? 0 : (bar.value < 11 ? 8 : 50),
                                    }}>
                                      {bar.value > 0 && bar.value >= 11 && <span style={{ fontSize: 14, fontWeight: 700, color: "#FFF", whiteSpace: "nowrap" }}>{Math.round(bar.value)} %</span>}
                                    </div>
                                    {bar.value < 11 && <span style={{ position: "absolute", left: `calc(${bar.value === 0 ? 0 : Math.min(Math.max(widthPct, 4), 100)}% + 8px)`, top: "50%", transform: "translateY(-50%)", fontSize: 14, fontWeight: 700, color: "#48484A", whiteSpace: "nowrap" }}>{Math.round(bar.value)} %</span>}
                                  </div>
                                </div>
                              );
                            })}
                  ...
                  {(() => {
                    ...
                    return (
                      <div style={{
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 10px 0", display: "flex", alignItems: "center", gap: 6 }}><Lightbulb style={{ width: 15, height: 15, color: "#1D1D1F", flexShrink: 0 }} />Ergebnis der Analyse</h3>
                        <p lang="de" style={{ fontSize: 14, color: "#48484A", lineHeight: 1.7, margin: 0, ...reportTextStyle }} data-testid="text-biocheck-collapsed-body">
                          {localizeText([...rt.body, ...(isLeadershipRole ? [rt.leadership] : [])].join(" "))}
                        </p>
                      </div>
                    );
