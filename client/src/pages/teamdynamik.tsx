  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, position: "relative" }}>
      ...
      <div style={{ flex: 1, position: "relative", height: 24 }}>
        ...
        {widthPct < 18 && <span style={{ position: "absolute", top: "50%", transform: "translateY(-50%)", left: `calc(${Math.min(Math.max(widthPct, 5), 100)}% + 10px)`, fontSize: 11, fontWeight: 700, color: "#48484A", whiteSpace: "nowrap" }}>{Math.round(value)} %</span>}
        <input
        ...
        return (
          <div key={b.label} style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1, height: 24, borderRadius: 6, background: "rgba(0,0,0,0.04)", position: "relative" }}>
              ...
              {widthPct < 18 && b.value >= 0 && <span style={{ position: "absolute", top: "50%", transform: "translateY(-50%)", left: `calc(${Math.min(Math.max(widthPct, 5), 100)}% + 10px)`, fontSize: 11, fontWeight: 700, color: "#48484A", whiteSpace: "nowrap" }}>{Math.round(b.value)} %</span>}
            </div>
          </div>
        );
      })}
