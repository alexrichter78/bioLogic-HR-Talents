                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div style={{ padding: "18px 22px", borderRadius: 14, background: "linear-gradient(135deg, #f8f9fb, #f1f3f8)", border: "1px solid rgba(0,0,0,0.05)" }}>
                    ...
                    <div style={{ display: "grid", gap: 10 }}>
                      <BarRow label={region === "EN" ? "Impulsive" : "Impulsiv"} value={Math.round(result.teamProfile.impulsiv)} color={COMP_HEX.impulsiv} />
                      <BarRow label={region === "EN" ? "Intuitive" : "Intuitiv"} value={Math.round(result.teamProfile.intuitiv)} color={COMP_HEX.intuitiv} />
                      <BarRow label={region === "EN" ? "Analytical" : "Analytisch"} value={Math.round(result.teamProfile.analytisch)} color={COMP_HEX.analytisch} />
                    </div>
                  </div>
                  <div style={{ padding: "18px 22px", borderRadius: 14, background: "linear-gradient(135deg, #f8f9fb, #f1f3f8)", border: "1px solid rgba(0,0,0,0.05)" }}>
                    <p style={{ fontSize: 11, fontWeight: 700, color: "#8E8E93", textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 14px" }}>Person</p>
                    <div style={{ display: "grid", gap: 10 }}>
                      <BarRow label={region === "EN" ? "Impulsive" : "Impulsiv"} value={Math.round(result.personProfile.impulsiv)} color={COMP_HEX.impulsiv} />
                      <BarRow label={region === "EN" ? "Intuitive" : "Intuitiv"} value={Math.round(result.personProfile.intuitiv)} color={COMP_HEX.intuitiv} />
                      <BarRow label={region === "EN" ? "Analytical" : "Analytisch"} value={Math.round(result.personProfile.analytisch)} color={COMP_HEX.analytisch} />
                    </div>
                  </div>
                </div>
