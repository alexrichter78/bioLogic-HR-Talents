        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "48px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06), 0 12px 48px rgba(0,0,0,0.04)", border: "1px solid rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ fontSize: 15, color: "#1D1D1F", lineHeight: 1.8 }}>
            ...
            <ul style={{ margin: "0 0 8px", paddingLeft: 20 }}>
              <li>Anmeldedaten (Benutzername, Passwort in gehashter Form)</li>
              ...
              <li>Technische Zugriffsdaten (IP-Adresse, Browsertyp, Zugriffszeitpunkt)</li>
            </ul>
            <p style={{ margin: "0 0 20px" }}>
              Analyse-Eingaben und -Ergebnisse werden nicht dauerhaft personenbezogen gespeichert, sofern keine explizite Speicherung durch den Nutzer erfolgt.
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>4. Keine dauerhafte Speicherung von Analysedaten</h2>
            <p style={{ margin: "0 0 20px" }}>
              Die Verarbeitung von Analyse-Eingaben und -Ergebnissen erfolgt in der Regel temporär (Session-basiert) ohne dauerhafte Speicherung personenbezogener Daten. Eine Identifizierung einzelner Personen anhand der Analysedaten durch den Anbieter erfolgt nicht.
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>5. SSL-/TLS-Verschlüsselung</h2>
            <p style={{ margin: "0 0 20px" }}>
            ...
            <p style={{ margin: "0 0 20px" }}>
              Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen. Grundlage für die Datenverarbeitung ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der technisch fehlerfreien Darstellung und Optimierung).
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>7. Nutzung der Software (SaaS)</h2>
            <p style={{ margin: "0 0 20px" }}>
              Die Anwendung ist als Software-as-a-Service (SaaS) konzipiert und wird von Kunden eigenständig genutzt. Die Verantwortung für die Eingabe personenbezogener Daten liegt beim jeweiligen Nutzer bzw. dem Unternehmen, das die Software einsetzt. Soweit der Kunde die Software zur Verarbeitung personenbezogener Daten Dritter (z.&nbsp;B. Mitarbeiter, Bewerber) verwendet, ist der Kunde selbst datenschutzrechtlich Verantwortlicher für diese Verarbeitung.
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>8. Einsatz von Künstlicher Intelligenz</h2>
            <p style={{ margin: "0 0 8px" }}>
              Zur Generierung von Auswertungen und Empfehlungen wird künstliche Intelligenz eingesetzt, insbesondere Dienste von OpenAI (OpenAI, L.L.C., San Francisco, USA). Dabei gilt:
            </p>
            <ul style={{ margin: "0 0 8px", paddingLeft: 20 }}>
              ...
              <li>Es werden keine automatisierten Entscheidungen im Sinne von Art. 22 DSGVO getroffen</li>
              <li>Die an OpenAI übermittelten Daten werden gemäss der OpenAI-Nutzungsbedingungen nicht zum Training von KI-Modellen verwendet (API-Nutzung)</li>
            </ul>
            <p style={{ margin: "0 0 20px" }}>
              Durch die Nutzung der OpenAI-API kann eine Datenübermittlung in die USA erfolgen (siehe Abschnitt «Datenübermittlung in Drittländer»).
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>9. Datenübermittlung in Drittländer</h2>
            <p style={{ margin: "0 0 20px" }}>
              Durch den Einsatz von OpenAI und ggf. des Hosting-Anbieters kann eine Übermittlung personenbezogener Daten in die USA oder andere Drittländer erfolgen. Die Übermittlung erfolgt auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO (Einwilligung durch Nutzung) bzw. Art. 49 Abs. 1 lit. b DSGVO (Vertragserfüllung) sowie, soweit vorhanden, auf Grundlage des EU-US Data Privacy Framework oder vergleichbarer Garantien (z.&nbsp;B. Standardvertragsklauseln gemäss Art. 46 Abs. 2 lit. c DSGVO).
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>10. Hosting</h2>
            <p style={{ margin: "0 0 20px" }}>
              Die Software wird über externe Hosting-Dienstleister betrieben (z.&nbsp;B. Render, San Francisco, USA, oder vergleichbare Anbieter). Diese verarbeiten Daten ausschliesslich im Rahmen der technischen Bereitstellung der Anwendung und handeln als Auftragsverarbeiter im Sinne von Art. 28 DSGVO.
            </p>
            ...
            <ul style={{ margin: "0 0 20px", paddingLeft: 20 }}>
              <li>Art. 6 Abs. 1 lit. a DSGVO (Einwilligung – soweit erteilt)</li>
              <li>Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung / Nutzung der Software)</li>
              <li>Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an stabiler Bereitstellung und Verbesserung der Anwendung)</li>
            </ul>
            ...
            <ul style={{ margin: "0 0 8px", paddingLeft: 20 }}>
              <li>an technisch notwendige Dienstleister (Hosting, KI-Verarbeitung)</li>
              <li>soweit gesetzlich vorgeschrieben oder zur Rechtsdurchsetzung erforderlich</li>
            </ul>
            <p style={{ margin: "0 0 20px" }}>
              Eine darüber hinausgehende Weitergabe an Dritte, insbesondere zu Werbe- oder Marketingzwecken, erfolgt nicht.
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>13. Cookies und lokaler Speicher</h2>
            <p style={{ margin: "0 0 20px" }}>
              Die Anwendung verwendet ausschliesslich technisch notwendige Cookies und lokalen Speicher (localStorage), um Sitzungen zu verwalten, Benutzereinstellungen (z.&nbsp;B. Regionauswahl) zu speichern und die Nutzung der Anwendung zu ermöglichen. Es werden keine Cookies zu Tracking-, Analyse- oder Marketingzwecken eingesetzt. Eine Einwilligung ist für technisch notwendige Cookies gemäss § 25 Abs. 2 TDDDG nicht erforderlich.
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>14. Aufbewahrungsfristen</h2>
            <p style={{ margin: "0 0 20px" }}>
              Personenbezogene Daten werden nur so lange gespeichert, wie dies für den jeweiligen Verarbeitungszweck erforderlich ist oder gesetzliche Aufbewahrungspflichten bestehen. Benutzerkonten können auf Anfrage jederzeit gelöscht werden. Analyse-Eingaben und -Ergebnisse werden in der Regel nicht dauerhaft gespeichert.
            </p>

            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>15. Rechte der betroffenen Personen</h2>
            <p style={{ margin: "0 0 8px" }}>
            ...
            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>16. Beschwerderecht bei der Aufsichtsbehörde</h2>
            <p style={{ margin: "0 0 20px" }}>
              Unbeschadet eines anderweitigen verwaltungsrechtlichen oder gerichtlichen Rechtsbehelfs steht Ihnen das Recht auf Beschwerde bei einer Aufsichtsbehörde zu, wenn Sie der Ansicht sind, dass die Verarbeitung Ihrer personenbezogenen Daten gegen die DSGVO verstösst. Die zuständige Aufsichtsbehörde ist:<br /><br />
            ...
            <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1D1D1F", margin: "0 0 8px" }}>18. Änderung dieser Datenschutzerklärung</h2>
            <p style={{ margin: "0 0 20px" }}>
              Wir behalten uns vor, diese Datenschutzerklärung anzupassen, um sie stets den aktuellen rechtlichen Anforderungen anzupassen oder Änderungen unserer Leistungen umzusetzen. Für Ihren erneuten Besuch gilt dann die jeweils aktuelle Datenschutzerklärung.
            </p>

            <p style={{ margin: "0 0 0", fontSize: 13, color: "#8E8E93" }}>
              Stand: März 2026 · © {new Date().getFullYear()} foresMind® GmbH. Alle Rechte vorbehalten.
            </p>
          </div>
        </div>
      </div>
