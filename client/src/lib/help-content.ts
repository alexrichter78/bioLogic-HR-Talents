...
const SECTIONS_DE: HelpSection[] = [
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/01-anmeldung.png", caption: "Anmelde-Maske",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/02-startseite.png", caption: "Startseite mit den beiden Hauptkarten",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/03-jobcheck.png", caption: "JobCheck — Tätigkeiten erfassen",
      ...
      { type: "image", src: "/help/04-rollenprofil.png", caption: "Stellenprofil-Bericht",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/05-matchcheck.png", caption: "MatchCheck — Bericht",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/06-teamcheck.png", caption: "TeamCheck — Bericht",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/07-ki-coach.png", caption: "Louis — Chat-Oberfläche",
        mock: { title: "Louis-Chat", bullets: ["Begrüßungstext von Louis", "Eingabefeld unten mit Plus-Symbol für Anhänge", "Buttons: Musterprompts, Neue Unterhaltung, Verlauf, Gespräch exportieren, Gespräch löschen", "Tipps-Bereich für bessere Antworten"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/08-kurs.png", caption: "Kursbereich — Modulübersicht",
...
const SECTIONS_EN: HelpSection[] = [
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/01-anmeldung.png", caption: "Sign-in screen",
        mock: { title: "Sign-in", bullets: ["bioLogic logo + subtitle 'HR Talents'", "Field: Username", "Field: Password (with eye icon to reveal)", "Language selector with country flags", "Link 'Forgot password?'", "Blue 'Sign in' button"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/02-startseite.png", caption: "Home screen with the two main cards",
        mock: { title: "Home screen", bullets: ["'Role Profile' card with description and bullet list", "Buttons 'New analysis' and 'Open analysis' (loads a saved file)", "'Louis' card with 'Open Louis' button", "Main navigation at the top with all areas"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/03-jobcheck.png", caption: "JobCheck — entering activities",
        mock: { title: "Step 3: Activities", bullets: ["List of activity cards (main task / secondary task / leadership)", "Per activity: competence picker (Impulsive / Intuitive / Analytical) and level (Low / Medium / High)", "Buttons 'New activity' and 'Analyse role'", "Target profile preview with three values"] } },
      ...
      { type: "image", src: "/help/04-rollenprofil.png", caption: "Role profile report",
        mock: { title: "Role profile report", bullets: ["Short profile of the role in plain language", "Three values (Impulsive / Intuitive / Analytical) as percentages", "Explanation of the role's dominant logic", "Buttons 'Edit role profile' and 'Save role profile'"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/05-matchcheck.png", caption: "MatchCheck — report",
        mock: { title: "MatchCheck report", bullets: ["Header with overall verdict (Suitable / Conditionally / Not suitable)", "Metrics: baseline fit, leadership effort, profile deviation, development effort", "Profile comparison (target vs. actual) with explanations", "Sections: strengths, watch-outs, critical points, behaviour under pressure, risk forecast", "30-day integration plan", "'Print' button (choose 'Save as PDF' in the print dialog)"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/06-teamcheck.png", caption: "TeamCheck — report",
        mock: { title: "TeamCheck report", bullets: ["Profile comparison (person vs. team)", "Metrics: system impact, integration effort, team fit, effect on team goal", "Sections: strengths of the appointment, risks of the appointment, opportunities, risks", "Behaviour under pressure, notes for the leader", "Phased integration plan with goals, practical examples, warning signs, guiding questions", "'Print' button (PDF export)"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/07-ki-coach.png", caption: "Louis — chat interface",
        mock: { title: "Louis chat", bullets: ["Welcome message from Louis", "Input field at the bottom with a plus icon for attachments", "Buttons: sample prompts, new conversation, history, export conversation, delete conversation", "Tips area for getting better answers"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/08-kurs.png", caption: "Courses — module overview",
        mock: { title: "Courses", bullets: ["Four module cards (Compact, Leadership, Recruiting, Sales) with preview images", "Notice box 'Content in preparation'", "For admins/sub-admins: additional fields for participants (first name, last name, email) with 'Add participant' and 'Enable access' buttons"] } },
    ],
  },
  {
    id: "profil",
...
const SECTIONS_FR: HelpSection[] = [
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/01-anmeldung.png", caption: "Écran de connexion",
        mock: { title: "Connexion", bullets: ["Logo bioLogic + sous-titre « HR Talents »", "Champ : Nom d'utilisateur", "Champ : Mot de passe (avec icône œil pour afficher)", "Sélecteur de langue avec drapeaux", "Lien « Mot de passe oublié ? »", "Bouton bleu « Se connecter »"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/02-startseite.png", caption: "Page d'accueil avec les deux cartes principales",
        mock: { title: "Page d'accueil", bullets: ["Carte « Profil du poste » avec description et liste à puces", "Boutons « Nouvelle analyse » et « Ouvrir une analyse » (charge un fichier enregistré)", "Carte « Louis » avec bouton « Ouvrir Louis »", "Navigation principale en haut avec toutes les rubriques"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/03-jobcheck.png", caption: "JobCheck — saisir les activités",
        mock: { title: "Étape 3 : Activités", bullets: ["Liste de cartes d'activités (tâche principale / secondaire / encadrement)", "Par activité : choix de la compétence (Impulsif / Intuitif / Analytique) et du niveau (Faible / Moyen / Élevé)", "Boutons « Nouvelle activité » et « Analyser le poste »", "Aperçu du profil cible avec trois valeurs"] } },
      ...
      { type: "image", src: "/help/04-rollenprofil.png", caption: "Rapport du profil de poste",
        mock: { title: "Rapport profil de poste", bullets: ["Profil court du poste en langage clair", "Trois valeurs (Impulsif / Intuitif / Analytique) en pourcentage", "Explication de la logique dominante du poste", "Boutons « Modifier le profil » et « Enregistrer le profil »"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/05-matchcheck.png", caption: "MatchCheck — rapport",
        mock: { title: "Rapport MatchCheck", bullets: ["En-tête avec verdict global (Adapté / Sous conditions / Non adapté)", "Indicateurs : adéquation de base, effort de pilotage, écart de profil, effort de développement", "Comparaison des profils (cible vs. réel) avec explications", "Sections : forces, points de vigilance, points critiques, comportement sous pression, prévision des risques", "Plan d'intégration sur 30 jours", "Bouton « Imprimer » (choisir « Enregistrer en PDF » dans la boîte de dialogue d'impression)"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/06-teamcheck.png", caption: "TeamCheck — rapport",
        mock: { title: "Rapport TeamCheck", bullets: ["Comparaison des profils (personne vs. équipe)", "Indicateurs : impact systémique, effort d'intégration, adéquation à l'équipe, effet sur l'objectif d'équipe", "Sections : force du recrutement, risques du recrutement, opportunités, risques", "Comportement sous pression, recommandations pour le manager", "Plan d'intégration en phases avec objectifs, ancrage pratique, signaux d'alerte, questions clés", "Bouton « Imprimer » (export PDF)"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/07-ki-coach.png", caption: "Louis — interface de chat",
        mock: { title: "Chat Louis", bullets: ["Message de bienvenue de Louis", "Champ de saisie en bas avec icône plus pour les pièces jointes", "Boutons : modèles de prompts, nouvelle conversation, historique, exporter la conversation, supprimer la conversation", "Zone de conseils pour de meilleures réponses"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/08-kurs.png", caption: "Formation — aperçu des modules",
        mock: { title: "Formation", bullets: ["Quatre cartes de module (Cours compact, Leadership, Recruiting, Sales) avec aperçus", "Bandeau « Contenu en préparation »", "Pour les admins/sous-admins : champs supplémentaires pour les participants (prénom, nom, e-mail) avec boutons « Ajouter un participant » et « Activer les accès »"] } },
    ],
  },
  {
    id: "profil",
...
const SECTIONS_IT: HelpSection[] = [
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/01-anmeldung.png", caption: "Schermata di accesso",
        mock: { title: "Accesso", bullets: ["Logo bioLogic + sottotitolo «HR Talents»", "Campo: Nome utente", "Campo: Password (con icona occhio per mostrarla)", "Selettore di lingua con bandiere", "Link «Password dimenticata?»", "Pulsante blu «Accedi»"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/02-startseite.png", caption: "Home con i due riquadri principali",
        mock: { title: "Home", bullets: ["Riquadro «Profilo del ruolo» con descrizione e elenco puntato", "Pulsanti «Nuova analisi» e «Apri analisi» (carica un file salvato)", "Riquadro «Louis» con pulsante «Apri Louis»", "Navigazione principale in alto con tutte le sezioni"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/03-jobcheck.png", caption: "JobCheck — inserire le attività",
        mock: { title: "Passo 3: Attività", bullets: ["Elenco di schede attività (compito principale / secondario / leadership)", "Per ogni attività: scelta della competenza (Impulsivo / Intuitivo / Analitico) e del livello (Basso / Medio / Alto)", "Pulsanti «Nuova attività» e «Analizza ruolo»", "Anteprima del profilo target con tre valori"] } },
      ...
      { type: "image", src: "/help/04-rollenprofil.png", caption: "Rapporto profilo del ruolo",
        mock: { title: "Rapporto profilo del ruolo", bullets: ["Profilo sintetico del ruolo in linguaggio chiaro", "Tre valori (Impulsivo / Intuitivo / Analitico) in percentuale", "Spiegazione della logica dominante del ruolo", "Pulsanti «Modifica profilo» e «Salva profilo»"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/05-matchcheck.png", caption: "MatchCheck — rapporto",
        mock: { title: "Rapporto MatchCheck", bullets: ["Intestazione con valutazione complessiva (Adatto / Con riserva / Non adatto)", "Indicatori: corrispondenza di base, impegno di leadership, scostamento di profilo, impegno di sviluppo", "Confronto dei profili (target vs. reale) con spiegazioni", "Sezioni: punti di forza, punti di attenzione, punti critici, comportamento sotto pressione, previsione di rischio", "Piano di integrazione di 30 giorni", "Pulsante «Stampa» (nella finestra di stampa scegli «Salva come PDF»)"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/06-teamcheck.png", caption: "TeamCheck — rapporto",
        mock: { title: "Rapporto TeamCheck", bullets: ["Confronto dei profili (persona vs. team)", "Indicatori: impatto sul sistema, impegno di integrazione, corrispondenza al team, effetto sull'obiettivo del team", "Sezioni: forza dell'inserimento, rischio dell'inserimento, opportunità, rischi", "Comportamento sotto pressione, indicazioni per la persona di leadership", "Piano di integrazione in fasi con obiettivi, esempi pratici, segnali d'allarme, domande guida", "Pulsante «Stampa» (esportazione PDF)"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/07-ki-coach.png", caption: "Louis — interfaccia di chat",
        mock: { title: "Chat di Louis", bullets: ["Messaggio di benvenuto di Louis", "Campo di inserimento in basso con icona più per gli allegati", "Pulsanti: prompt di esempio, nuova conversazione, cronologia, esporta conversazione, elimina conversazione", "Area di consigli per ottenere risposte migliori"] } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image", src: "/help/08-kurs.png", caption: "Formazione — panoramica dei moduli",
        mock: { title: "Formazione", bullets: ["Quattro schede modulo (Corso compatto, Leadership, Recruiting, Sales) con immagini di anteprima", "Riquadro di nota «Contenuti in preparazione»", "Per amministratori/sotto-amministratori: campi aggiuntivi per i partecipanti (nome, cognome, e-mail) con pulsanti «Aggiungi partecipante» e «Abilita accessi»"] } },
    ],
  },
  {
    id: "profil",
