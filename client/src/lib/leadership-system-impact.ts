...
export type SystemImpactResult = {
  show: boolean;
...
export function calculateLeadershipSystemImpact(
  ...
  if (role !== "fuehrung" && role !== "Führungskraft" && role !== "leadership") {
    return { show: false, label: null, text: null, variant: null, reasons: [], metrics: null };
  }
  ...
  const variant: "success" | "warning" | "danger" =
    label === "Verstärkung" ? "success" : label === "Spannung" ? "warning" : "danger";
