...
export const REPORT_LABELS = {
  ...
  en: {
    ...
    structureExplanation:
      "Every person carries the three fundamental modes of thinking and acting: Action-oriented, Relational and Analytical. All three are always present. What differs is their order and weighting.",
    structureExplanation2:
    ...
    barLabelImp: "Action-oriented",
    barLabelInt: "Relational",
  ...
  fr: {
    ...
    structureExplanation:
      "Chaque personne possède les trois modes fondamentaux de pensée et d'action : Orienté action, Relationnel et Analytique. Les trois sont toujours présents. Ce qui diffère, c'est leur ordre et leur pondération.",
    structureExplanation2:
    ...
    barLabelImp: "Orienté action",
    barLabelInt: "Relationnel",
    barLabelAna: "Analytique",
  ...
  it: {
    ...
    structureExplanation:
      "Ogni persona dispone dei tre modi fondamentali di pensiero e azione: Orientato all'azione, Relazionale e Analitico. Tutti e tre sono sempre presenti. Ciò che varia è il loro ordine e la loro ponderazione.",
    structureExplanation2:
    ...
    barLabelImp: "Orientato all'azione",
    barLabelInt: "Relazionale",
    barLabelAna: "Analitico",
