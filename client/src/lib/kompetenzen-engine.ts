...
const BERUFS_PROFILE: Record<string, {
  ...
  "projektleiter": {
    haupt: [
      ...
      ["Durchführung von Risikoanalysen und Ableitung präventiver Massnahmen zur Projektsicherung", "Analytisch", "Hoch"],
      ...
      ["Stakeholder-Management und regelmässige Kommunikation mit Auftraggebern und Fachbereichen", "Intuitiv", "Hoch"],
  ...
  "vertriebsleiter": {
    haupt: [
      ...
      ["Reporting der Vertriebskennzahlen und Ableitung operativer Massnahmen", "Analytisch", "Mittel"],
      ["Koordination mit Marketing, Produktmanagement und Innendienst zur Kundenzufriedenheit", "Intuitiv", "Mittel"],
      ["Erschliessung neuer Märkte und Vertriebskanäle im In- und Ausland", "Impulsiv", "Mittel"],
  ...
  "personalleiter": {
    haupt: [
      ...
      ["Konzeption und Durchführung von Personalentwicklungsmassnahmen und Talentprogrammen", "Intuitiv", "Hoch"],
      ...
      ["Aufbau einer attraktiven Arbeitgebermarke und Employer-Branding-Massnahmen", "Intuitiv", "Mittel"],
  ...
  "produktionsleiter": {
    haupt: [
      ...
      ["Abstimmung mit Qualitätsmanagement bei Reklamationen und Korrekturmassnahmen", "Analytisch", "Niedrig"],
  ...
  "key account manager": {
    haupt: [
      ...
      ["Verhandlung komplexer Verträge und Rahmenvereinbarungen mit Grosskunden", "Impulsiv", "Hoch"],
      ...
      ["Durchführung regelmässiger Business Reviews und Präsentationen beim Kunden", "Intuitiv", "Mittel"],
      ...
      ["Lösung von Eskalationen und Reklamationen durch schnelle Entscheidungen und Massnahmen", "Impulsiv", "Mittel"],
  ...
  "geschäftsführer": {
    haupt: [
      ...
      ["Analyse der Marktposition und Ableitung wettbewerbsfähiger Massnahmen", "Analytisch", "Mittel"],
      ...
      ["Monitoring der Unternehmenskennzahlen und Einleitung korrektiver Massnahmen", "Analytisch", "Mittel"],
  ...
  "einkäufer": {
    haupt: [
      ...
      ["Durchsetzung von Kostensenkungszielen und Einsparmassnahmen im Einkaufsvolumen", "Impulsiv", "Hoch"],
      ...
      ["Beobachtung von Rohstoffmärkten und Einleitung von Preisabsicherungsmassnahmen", "Analytisch", "Mittel"],
  ...
  "teamleiter": {
    haupt: [
      ...
      ["Durchführung regelmässiger Mitarbeitergespräche und Vereinbarung individueller Ziele", "Intuitiv", "Hoch"],
      ...
      ["Identifikation von Entwicklungspotenzialen und Ableitung geeigneter Qualifizierungsmassnahmen", "Intuitiv", "Mittel"],
      ...
      ["Umsetzung strategischer Vorgaben in operative Massnahmen für das Team", "Impulsiv", "Mittel"],
  ...
  "koch": {
    haupt: [
      ...
      ["Kalkulation von Rezepturen und Portionsgrössen zur Einhaltung der Zielkosten", "Analytisch", "Mittel"],
  ...
  "qualitätsmanager": {
    haupt: [
      ...
      ["Analyse von Fehler- und Reklamationsdaten zur Ableitung systematischer Verbesserungsmassnahmen", "Analytisch", "Hoch"],
      ...
      ["Koordination von Korrektur- und Vorbeugemassnahmen über Fachbereiche hinweg", "Intuitiv", "Mittel"],
...
const NEBEN_POOL: Record<KompetenzTyp, [string, Niveau][]> = {
  "Impulsiv": [
    ...
    ["Selbstdisziplin und konsequente Umsetzung vereinbarter Massnahmen", "Niedrig"],
  ],
  "Intuitiv": [
...
const FUEHRUNG_TEMPLATES: Record<string, [string, KompetenzTyp, Niveau][]> = {
  "Projekt-/Teamkoordination": [
    ...
    ["Moderation von Teammeetings mit Ergebnissicherung und Massnahmenverfolgung", "Intuitiv", "Hoch"],
  ...
  "Fachliche Führung": [
    ...
    ["Identifikation von Kompetenzlücken und Initiierung gezielter Weiterbildungsmassnahmen", "Intuitiv", "Mittel"],
