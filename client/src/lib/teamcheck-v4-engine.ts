...
function buildChancenRisiken(c: Ctx): { chancen: V4Block[]; risiken: V4Block[]; chancenRisikenEinordnung: string } {
  ...
  if (c.score >= 85) {
    ...
    einordnung = "Die Risiken überwiegen. Die Unterschiede erfordern viel Führungsaufwand. Die Besetzung kann trotzdem richtig sein — aber nur, wenn die Unterschiede gewollt sind und das Team diese Erweiterung tatsächlich braucht.";
  }
