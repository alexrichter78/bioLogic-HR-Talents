# bioLogic RoleDynamics — Marketing-Dokumentation

**Stand:** April 2026
**Zweck:** Inhaltliche Grundlage für Landingpage, Verkaufsunterlagen, Pitch-Decks
**Lesezeit:** ca. 12 Minuten

---

## 1. Was ist bioLogic RoleDynamics in einem Satz
...
- **Hauptvariante (analytisch-beweisend):**
  „Die richtige Person auf der richtigen Stelle — in 15 Minuten objektiv belegt, statt nach Bauchgefühl entschieden."

- **Variante (intuitiv-emotional):**
...
## 2. Vorteile der Software (Top-Level)

Die wichtigsten Nutzen-Versprechen, sortiert nach Aussagekraft auf der Landingpage:

1. **Sofort-Diagnose statt Wochen-Assessment.** Innerhalb weniger Minuten erhalten Anwender ein vollständiges Persönlichkeitsprofil ihrer Kandidaten oder Mitarbeitenden — ohne externes Beratungshaus, ohne tagelange Workshops.
...
## 3. Die größten Herausforderungen im HR-Bereich — und wie die Software sie löst

Diese Sektion liefert den **Problem-Lösung-Block** für die Landingpage. Jede Herausforderung ist eine eigene Sektion oder ein FAQ-Eintrag.
...
**Was bioLogic RoleDynamics tut:** Führt Person und Rolle in einem objektivierten Profilabgleich zusammen. Die Software zeigt vor der Einstellung, ob die Persönlichkeitsanteile zur Rolle passen — nicht erst nach drei Monaten Probezeit.
...
**Was bioLogic RoleDynamics tut:** Zerlegt jede Rolle in messbare Persönlichkeitsanforderungen mit klarer Gewichtung. Aus „kommunikationsstark" wird „70 % intuitiver Anteil, dominante Beziehungsorientierung". Daraus entsteht eine Stellenanzeige, die genau die Menschen anspricht, die wirklich passen.
...
**Was bioLogic RoleDynamics tut:** Macht die Persönlichkeitsdynamik im Team sichtbar, bevor sie eskaliert. Führungskräfte sehen, **warum** ein Konflikt entsteht — und können ihn benennen, statt ihn auszusitzen. Louis liefert dazu konkrete Gesprächsstrategien.
...
**Was bioLogic RoleDynamics tut:** Konserviert HR-Erfahrung in Louis und im strukturierten Profilmodell. Auch eine junge HR-Mitarbeiterin trifft mit der Software Entscheidungen auf dem Niveau einer Senior-Personalberaterin — weil das Modell und der Coach die Erfahrung mitliefern.

### Herausforderung 5: Mitarbeitergespräche bleiben oberflächlich oder werden vermieden

**Realität:** Führungskräfte führen Mitarbeitergespräche ungern, weil ihnen die Sprache und der Leitfaden fehlen. Das Ergebnis: Standard-Floskeln, keine echten Erkenntnisse, frustrierte Mitarbeitende.

**Was bioLogic RoleDynamics tut:** Liefert vor jedem Gespräch eine Persönlichkeits-Briefing-Karte des Gegenübers — was treibt diese Person an, was demotiviert sie, wie sollte man mit ihr sprechen. Louis erstellt auf Wunsch komplette Gesprächsleitfäden, die in 5 Minuten lesbar sind.

### Herausforderung 6: Recruiting-Marketing erreicht die falschen Bewerber

**Realität:** Stellenanzeigen sind in einer Sprache geschrieben, die zu allen passt — und damit zu niemandem. Die Folge: viele unpassende Bewerbungen, hoher Filteraufwand, immer noch Fehlbesetzungen.

**Was bioLogic RoleDynamics tut:** Generiert Stellenanzeigen, deren Sprache, Bildwelt und Ansprache exakt auf den Persönlichkeitstyp der Wunschbewerber zugeschnitten ist. Wenn die Stelle einen analytischen Anteil verlangt, sprechen die Anzeige und das Recruiting-Bild gezielt analytische Menschen an — nicht alle gleichzeitig.

---

## 4. Der Kunden-Hebel: Was die Arbeit mit der Software beim Anwender wirklich bewirkt

Diese Sektion ist der **emotionale Mehrwert** für die Landingpage — wofür die Anwender wirklich bezahlen.

### Hebel 1: Entscheidungssicherheit — und damit weniger Schlaflosigkeit

Personalentscheidungen sind die Entscheidungen, die Geschäftsführer und HR-Verantwortliche nachts wachhalten. Mit einem objektiven Profilabgleich verschwindet das Bauchgrummeln. Die Entscheidung liegt nicht mehr nur auf der Schulter einer Person.

### Hebel 2: Aus „Personalverwaltung" wird strategische Unternehmensgestaltung

HR ist in vielen Mittelständlern noch Lohnabrechnung plus Reisekosten. Mit bioLogic RoleDynamics wird HR zur Funktion, die Führungskräften beweisbar bessere Entscheidungen ermöglicht — und damit auch im Unternehmen sichtbar aufgewertet.
...
## 5. Monetäre Vorteile — der Business Case

Diese Sektion ist die **ROI-Begründung** für die Landingpage. Wer einen Geschäftsführer überzeugen will, braucht Zahlen.

### Direkte Einsparungen

| Posten | Konventionell | Mit bioLogic RoleDynamics | Einsparung pro Jahr (mittelständisches Beispiel: 100 MA, 15 Einstellungen) |
|---|---|---|---|
...
## 6. Was bioLogic RoleDynamics unvergleichbar macht
...
| Was andere Lösungen tun | Was bioLogic RoleDynamics zusätzlich tut |
|---|---|
| **Bewerbermanagement-Systeme** (Personio, Workday, SAP SuccessFactors) verwalten Bewerbungen, organisieren Prozesse, dokumentieren. | bioLogic RoleDynamics **bewertet** die Eignung, statt sie nur zu dokumentieren. |
| **Persönlichkeitstests** (DISG, MBTI, Big Five, Hogan, Reiss) liefern ein Persönlichkeitsprofil der Person. | bioLogic RoleDynamics liefert **zusätzlich** ein Persönlichkeitsprofil der **Rolle** und macht beide vergleichbar — der Punkt, an dem alle anderen aufhören. |
| **Recruiting-Plattformen** (LinkedIn, Indeed, StepStone) liefern Reichweite und Kandidaten. | bioLogic RoleDynamics liefert die **richtigen** Kandidaten, weil die Stellenanzeige zielgruppenpsychologisch optimiert ist. |
| **HR-Analytics-Tools** liefern Kennzahlen über Belegschaft, Fluktuation, Diversität. | bioLogic RoleDynamics liefert die **Erklärung** für diese Kennzahlen und konkrete Handlungsempfehlungen pro Person. |
...
| **Marketing-Persona-Tools** (HubSpot, Sparktoro) erstellen Käufer-Personas. | bioLogic RoleDynamics nutzt **dasselbe Modell** für Personalentscheidungen UND Käufer-Personas — die einzige Software, die HR und Marketing-Psychologie auf einer Sprache verbindet. |
...
## 7. Die USPs auf einen Blick — der Werbeblock
...
## 8. Bausteine für die Landingpage-Struktur

Empfohlener Aufbau, von oben nach unten:
