...
export class DatabaseStorage implements IStorage {
  ...
  async searchKnowledgeDocuments(query: string): Promise<KnowledgeDocument[]> {
    ...
    const SYNONYM_MAP: Record<string, string[]> = {
      ...
      "gfk": ["gewaltfreie kommunikation", "rosenberg", "bedürfnisse", "beobachtung"],
      "gewaltfreie kommunikation": ["gfk", "rosenberg", "bedürfnisse", "bitten"],
      "okr": ["objectives", "key results", "zielsetzung", "ziele"],
      "design thinking": ["empathize", "ideation", "prototyping", "nutzerbedürfnisse"],
      "psychological safety": ["psychologische sicherheit", "edmondson", "vertrauen", "fehlerkultur"],
      "change management": ["kotter", "veränderung", "transformation", "wandel"],
      "lean": ["kaizen", "verschwendung", "prozessoptimierung", "effizienz"],
      "360": ["360-grad", "feedback", "rückmeldung", "fremdwahrnehmung"],
      "konstellation": ["profil", "prägung", "rgb", "rbg", "grb", "gbr", "bgr", "brg", "alltie", "doppeldominanz"],
